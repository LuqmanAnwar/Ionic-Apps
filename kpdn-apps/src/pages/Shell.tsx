...
const Shell: React.FC = () => {
  ...
  useEffect(() => {
    fetch("https://52c5-203-142-6-113.ngrok-free.app/api/invest1")
      .then((response) => {
        if (!response.ok) {
  ...
  useEffect(() => {
    fetch("https://52c5-203-142-6-113.ngrok-free.app/api/invest2")
      .then((response) => {
        if (!response.ok) {
          throw new Error("Network response was not ok");
        }
  ...
  useEffect(() => {
    fetch("https://52c5-203-142-6-113.ngrok-free.app/api/invest3")
      .then((response) => {
        if (!response.ok) {
          throw new Error("Network response was not ok");
        }
  ...
  const createChartInvest3 = (data: ApiResponseInvest3) => {
    if (chartInstanceInvest3) {
      chartInstanceInvest3.dispose();
    }
